...
let AuthRepository = class AuthRepository {
    constructor(credentialsService, jwtServiceRepository) {
        this.credentialsService = credentialsService;
        this.jwtServiceRepository = jwtServiceRepository;
    }
    ...
    generateToken(payload) {
        try {
            ...
            if (!token)
                throw new common_1.BadRequestException('Hubo un error al generar el token');
            return token;
        }
        catch (error) {
