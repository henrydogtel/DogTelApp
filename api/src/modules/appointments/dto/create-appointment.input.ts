...
export class CreateAppointmentInput {
  ...
  @Field(() => String, { description: 'Fecha de inicio de la cita' , nullable:true })
  entryDate?: Date; 

  @Field(() => String, { description: 'Fecha de finalización de la cita' , nullable:true })
  departureDate?: Date; 

  @Field(() => String, { description: 'Hora de la cita', nullable:true  })
  timeIn?: Timestamp; 

  @Field(() => String, { description: 'Hora del final de la cita', nullable:true  })
  timeOut?: Timestamp; 
