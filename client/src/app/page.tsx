  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex justify-center items-start p-12">
        ...
        <div className="w-1/3 flex flex-col items-center justify-center p-8 bg-[#fffaf0] shadow-lg rounded-lg ml-8">
      ...
      <div className="flex justify-center space-x-4 px-12 pb-12">
        <div className="w-1/4 p-4 bg-white shadow-lg rounded-lg">
          <img src="/carla.jpg" alt="Carla M." className="w-full h-48 object-cover rounded-lg mb-4" />
        ...
        <div className="w-1/4 p-4 bg-white shadow-lg rounded-lg">
          <img src="/juan.jpg" alt="Juan P." className="w-full h-48 object-cover rounded-lg mb-4" />
        ...
        <div className="w-1/4 p-4 bg-white shadow-lg rounded-lg">
          <img src="/lucia.jpg" alt="Lucía G." className="w-full h-48 object-cover rounded-lg mb-4" />
        ...
        <div className="w-1/4 p-4 bg-white shadow-lg rounded-lg">
          <img src="/santiago.jpg" alt="Santiago R." className="w-full h-48 object-cover rounded-lg mb-4" />
