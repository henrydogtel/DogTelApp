    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex justify-center items-start p-12">
        <div className="w-2/3 p-8 bg-[#fff9d4] shadow-lg rounded-lg">
          <h2 className="text-3xl font-bold mb-6 text-center text-[#b17457]">
            What defines us?
          </h2>
        ...
        <div className="w-full flex flex-col items-center">
          <div className="relative w-1/2 flex flex-col items-center justify-center p-8 bg-[#b17457] shadow-lg rounded-lg mb-8">
            <h2 className="text-2xl font-bold mb-4 text-[#fff9d4]">
              Do you want to be a dog sitter?
            </h2>
            <Link href="/registerSitter">
              <button className="px-6 py-3 bg-[#ffead] text-[#fff9d4] font-semibold rounded-lg shadow-lg hover:bg-[#98624b] transition duration-300">
                Click here
              </button>
            </Link>
          ...
          <div className="relative w-1/2 flex flex-col items-center justify-center p-8 bg-[#fff9d4] shadow-lg rounded-lg">
            <h2 className="text-2xl font-bold mb-4 text-[#b17457]">
      ...
      <div className="text-center py-12">
        <h3 className="text-xl font-bold text-[#b17457]">
