    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex justify-center items-start p-12">
        <div className="w-2/3 p-8 bg-[#fff9d4] shadow-lg rounded-lg">
          <h2
            className={`${concertOne.className} text-4xl font-bold mb-9 text-center text-[#b17457]`}
          >
            WHAT DEFINES US?
          </h2>
          <ul className="space-y-4">
            <li>
              <h3
                className={`${concertOne.className} text-lg font-semibold text-[#f08b5c]`}
              >
                ● Personalized Care:
              </h3>
        ...
        <div className="w-full flex flex-col items-center">
          <div className="relative w-1/2 flex flex-col items-center justify-center p-8 bg-[#b9881ec0] shadow-lg rounded-lg mb-8">
            <h2
              className={`${concertOne.className} text-2xl font-bold mb-4 text-[#ffffff]`}
            >
              Do you want to be a dog sitter?
            </h2>
            <Link href="/registerSitter">
              <button className="px-6 py-3 bg-[#ffead] text-white font-semibold rounded-lg shadow-lg hover:bg-[#b9881e89] transition duration-300">
                <p className={`${neucha.className} text-white`}>Click here</p>
              </button>
            </Link>
          ...
          <div className="relative w-1/2 flex flex-col items-center justify-center p-8 bg-[#b96b1ea0] shadow-lg rounded-lg">
            <h2
              className={`${concertOne.className} text-2xl font-bold mb-4 text-[#ffffff]`}
            >
            ...
            <Link href="/registerOwner">
              <button className="px-6 py-3 bg-[#ffead] text-white font-semibold rounded-lg shadow-lg hover:bg-[#a46c3567] transition duration-300">
                <p className={`${neucha.className} text-white font-semibold`}>
                  Click here
                </p>
              </button>
            </Link>
      ...
      <div className="text-center py-12">
        <h3
          className={`${concertOne.className} text-4xl font-bold text-[#c46337]`}
        >
      ...
      <div className="flex justify-center space-x-4 px-12 pb-12">
        {["carla.jpg", "juan.jpg", "lucia.jpg", "santiago.jpg"].map(
          (src, idx) => (
            <div
              key={idx}
              className="w-1/4 p-4 bg-[#dac898] shadow-lg rounded-lg"
            >
              <Image
                src={`/${src}`}
              ...
              />
              <h4
                className={`${concertOne.className} text-lg font-bold mb-2 text-[#ffffff]`}
              >
                {src.split(".")[0].toUpperCase()}
              </h4>
              <p className={`${neucha.className} text-[#eaa238]`}>
                🌟 <span className="font-bold">Rating</span>:{" "}
                {Math.random().toFixed(1) * (5 - 4.7) + 4.7}/5
              </p>
              <p className={`${neucha.className} text-[#774d39]`}>
                {idx === 0
