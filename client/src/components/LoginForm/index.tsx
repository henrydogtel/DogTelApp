  ...
  return (
    ...
    >
      ...
      <div className="relative z-0 w-full mb-6 group">
        ...
        />
        <label
          className={`${neucha.className} absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 peer-focus:text-[#ffb87e] peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6`}
        >
          Email Address
        </label>
      ...
      <div className="flex flex-col items-center mt-6">
        <h1
          className={`${concertOne.className} text-xl font-semibold text-[#f68f53]`}
        >
